...
<link rel="stylesheet" href="${ctx}/css/hot.css">
</head>
<body>
	...
	<div class="container-fluid">
		...
		<div class="crumbs">
			...
			<a href="#"><span id="region">全部</span>招考公告</a>&nbsp;>
			<span id="bank"></span>
		</div>
		...
		<hr style="padding: 0;margin: 0">
			...
			<div class="page-wrap">
					<div class="page-num">
						<ul>
							<span id="page" style="display:inlint-block;float:left">
...
/* 			$("body").on("mouseenter",".position-box li",function(){
	     	...
	     	for(var i = 0; i < result.news.length; i++){
	     		$("#tabContent").append(
					"<div class='listContent'>"+
						...
						"</div>"+
						"<div class='right-message'>"+
								"<a href='article.action?id="+result.news[i].newsid+"'>"+
		...
		function getnewssimple(startid,areano,bankno){
			 $.ajax({ 
					async:false,
				     type : "POST", //提交方式 
				     url : "http://localhost:8080/Yucai/getnewssimple.action",//路径 
